...
const Footer = () => {
  ...
  return (
    <footer className="bg-foreground text-primary-foreground pt-10 pb-6 px-4">
        ...
        <div className="grid gap-6 md:grid-cols-2 items-center">
          ...
          <form onSubmit={handleSubscribe} className="newsletter-form">
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                type="email"
                className="w-full rounded-lg border border-border bg-background px-4 py-3 text-sm text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/10"
              ...
              />
              <button
                className="inline-flex items-center justify-center rounded-full bg-secondary px-6 py-3 text-sm font-semibold text-primary-foreground transition hover:opacity-90"
                type="submit"
              >
                Subscribe
              </button>
